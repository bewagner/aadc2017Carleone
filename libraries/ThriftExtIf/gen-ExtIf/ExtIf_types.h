...
TDataResult() : classification(), probability(0), ymin(0), xmin(0), ymax(0), xmax(0), orientation(),  kid(false){
  }
  ...
  void __set_orientation(const std::string& val);
  
  void __set_probability(const double val);
  void __set_kid(const bool val);

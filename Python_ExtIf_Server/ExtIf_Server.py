...
# These two lines decide which model we use. Uncomment the first line for the google object detection API and the second line for the yolo model

from tf_classification import tf_classification_init, classify_image
# from yolo_classification import tf_classification_init, classify_image
